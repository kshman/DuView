namespace DuView
{
	partial class PageSelectForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.PageInfoLabel.Text = Du.Globalization.Locale.Text(2301);
			...
			// PlFileNameColumn
			// 
			this.PlFileNameColumn.Text = Du.Globalization.Locale.Text(2302);
			this.PlFileNameColumn.Width = 76;
			// 
			// PlDateColumn
			// 
			this.PlDateColumn.Text = Du.Globalization.Locale.Text(2303);
			this.PlDateColumn.Width = 150;
			// 
			// PlSizeColumn
			// 
			this.PlSizeColumn.Text = Du.Globalization.Locale.Text(2304);
			...
			this.Text = Du.Globalization.Locale.Text(2300);
