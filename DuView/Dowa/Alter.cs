...
{
    private static readonly string[] s_boolNames = ["TRUE", "YES", "CHAM", "OK", "1"];
    ...
    {
        return string.IsNullOrEmpty(s) ? failRet : s_boolNames.Any(x => x.Equals(s, StringComparison.OrdinalIgnoreCase));
    }
    ...
    /// AARRGGBB 문자열을 색깔로
    /// </summary>
    /// <param name="s">AARRGGBB 형식의 16진수 문자열입니다.</param>
    /// <param name="failRet">변환에 실패할 경우 반환할 색상입니다.</param>
    /// <returns>변환된 Color 값 또는 실패 시 failRet 값을 반환합니다.</returns>
    ...
    /// </summary>
    /// <param name="s">AARRGGBB 형식의 16진수 문자열입니다.</param>
    /// <returns>변환된 Color 값 또는 실패 시 Color.Transparent를 반환합니다.</returns>
    ...
    /// 문자열을 포인트로
    /// </summary>
    /// <param name="x">X 좌표 문자열입니다.</param>
    /// <param name="y">Y 좌표 문자열입니다.</param>
    /// <param name="failRet">변환에 실패할 경우 반환할 Point 값입니다.</param>
    /// <returns>변환된 Point 값 또는 실패 시 failRet 값을 반환합니다.</returns>
    ...
    /// 문자열을 사이즈로
    /// </summary>
    /// <param name="width">너비 문자열입니다.</param>
    /// <param name="height">높이 문자열입니다.</param>
    /// <param name="failRet">변환에 실패할 경우 반환할 Size 값입니다.</param>
    /// <returns>변환된 Size 값 또는 실패 시 failRet 값을 반환합니다.</returns>
