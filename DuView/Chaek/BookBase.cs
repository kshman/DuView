...
public abstract class BookBase : IDisposable
{
    ...
    protected readonly List<object> Entries = new();
    ...
    private PageImage ReadPage(int pageNo)
    {
        if (pageNo < 0 || pageNo >= TotalPage)
            return new PageImage(Resources.ouch_noimg);
        ...
        return frames != null ? new PageImage(frames) : img != null ? new PageImage(img) : new PageImage(Resources.ouch_noimg);
    }
